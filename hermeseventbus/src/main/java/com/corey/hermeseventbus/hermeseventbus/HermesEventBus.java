...
package com.corey.hermeseventbus.hermeseventbus;
...
import com.corey.hermeseventbus.concurrentutils.ObjectCanary2;
import com.corey.hermeseventbus.concurrentutils.util.Action;
import com.corey.hermeseventbus.concurrentutils.util.Function;
...
public class HermesEventBus {
    ...
    private com.corey.hermeseventbus.hermes.HermesListener hermesListener;
    ...
    public void setHermesListener(com.corey.hermeseventbus.hermes.HermesListener hermesListener){
    ...
    public class HermesListener extends com.corey.hermeseventbus.hermes.HermesListener {
